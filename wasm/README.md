...
The wrapper does not expose C++ objects to the browser. `Calculator::calculateAndPrint()` is used for the formatted result and libqalculate's own parser/evaluator remains responsible for expression semantics.
